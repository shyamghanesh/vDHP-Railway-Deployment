...
// Import module components (we'll create these)
...
export const DoctorDashboard: React.FC = () => {
  ...
  React.useEffect(() => {
    const loadDoctorName = () => {
      try {
        ...
        const { getCurrentDoctorProfile } = require('@/services/doctorService');
  ...
  const profile = (() => {
    ...
    return { user: 'Doctor', hospitalName: 'City General Hospital', branch: 'Downtown Campus' };
  })();
