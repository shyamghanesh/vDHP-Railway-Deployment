...
import { createAppointment, type AppointmentCreate } from '@/services/appointmentService';
...
export const AppointmentCreation: React.FC<AppointmentCreationProps> = ({ onAppointmentCreated }) => {
  ...
  const [formData, setFormData] = useState<AppointmentCreate & { date: Date | undefined }>({
    patientId: '',
    doctorId: '',
    scheduledDate: '',
    scheduledTime: '',
  ...
  const loadData = async () => {
    ...
    try {
      const [doctorsData, patientsData] = await Promise.all([
        getAllDoctorsFromBackend().catch(() => []),
