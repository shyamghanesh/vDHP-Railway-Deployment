...
import { getAppointmentsByDoctor, type Appointment } from '@/services/appointmentService';
...
import { ensurePatientInBackend } from '@/services/patientApiService';
...
export const DashboardOverview: React.FC = () => {
  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      const [dashboardStats, appointments, patientsData, prescriptions] = await Promise.all([
        getDashboardStats().catch(() => null),
        getAppointmentsByDoctor(doctorId).catch(() => []),
