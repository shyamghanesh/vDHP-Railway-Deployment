...
async def update_appointment_status(appointment_id: str, status_data: AppointmentStatusUpdate):
    """
    Update appointment status (accept/reject)
    
    Doctor uses this to accept or reject an appointment.
    """
    try:
        updated_appointment = data_store.update_appointment(appointment_id, status_data.status)
